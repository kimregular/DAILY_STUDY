...
## 증명
초기값을 10으로 가지고, 원소가 꽉 차면 길이를 2배로 늘리는 리스트라고 가정한다.

1. 배열 크기가 10일 때, 크기를 20으로 늘리면서 10번 복사
2. 배열 크기가 20일 때, 크기를 40으로 늘리면서 20번 복사
3. 배열 크기가 40일 때, 크기를 80으로 늘리면서 40번 복사
4. ...
...
$$ 10 + 20 + 40 + ... + \frac{N}{2} = 10 * \frac{2^N - 1}{N - 1} $$
